...
if(isset($_POST[submit]))
{
	...
	{
	$sql="INSERT INTO `produce`(`produce_id`, `category_id`, `produce`, `description`, `img`, `status`) VALUES (NULL,'$_POST[category]','$_POST[produce]','$_POST[description]','$imgname1','$_POST[status]')";	
