...
if(isset($_POST[submit]))
{
	...
	$sql="INSERT INTO `article`(`article_id`, `article_type`, `publish_date`, `title`, `article_description`, `article_img1`, `article_img2`, `article_img3`, `article_img4`, `article_img5`, `status`) VALUES (NULL,'$_POST[articletype]','$_POST[publishdate]','$_POST[title]','$description','$imgname1','$imgname2','$imgname3','$imgname4','$imgname5','Active')";
	if(!mysqli_query($con,$sql))
		{
