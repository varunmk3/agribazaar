...
if($_SESSION[randnumber]  == $_POST[randnumber])
{
	if(isset($_POST[submit]))
	{
		...
		{
		$sql="INSERT INTO `category`(`category_id`, `category`, `category_type`, `description`, `img`, `status`) VALUES (NULL,'$_POST[category]','$_POST[categorytype]','$_POST[description]','$imgname1','$_POST[status]')";
		if(!mysqli_query($con,$sql))
			{
				echo "Error in mysqli query";
			}
