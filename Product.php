...
$sql = $sql . " , quantity, quantity_type, description, uploaded_date, status) VALUES (NULL,'$_SESSION[sellerid]','$_POST[category]','$_POST[produce]','$_POST[variety]','$_POST[title]','$imgname1'";
if($_FILES[img2][name] != "")
{
$sql = $sql . " ,'$imgname2'";
}
